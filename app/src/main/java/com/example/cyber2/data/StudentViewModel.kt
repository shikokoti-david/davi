...
class StudentViewModel : ViewModel() {
                ...
                try {
                    ...
                    if (response.isSuccessful) {
                        ...
                        val student = StudentModel(
                            name, gender, course, summary,nationality, imageUrl, studentId
        ...
        fun updateStudent(
            ...
            val updatedStudent = StudentModel(
                "",
                name, gender,
                course, summary, nationality, studentId
            )
            ...
            fun deleteStudent(
                context: Context, studentId: String,
                navController: NavController
            ) {
                    ...
                    .setPositiveButton("Yes") { _, _ ->
                        ...
                        databaseReference.removeValue().addOnCompleteListener { task ->
                            if (task.isSuccessful) {
                                ...
                                Toast.makeText(context, "Student not deleted", Toast.LENGTH_LONG)
                                    .show()
                            }
                        }
