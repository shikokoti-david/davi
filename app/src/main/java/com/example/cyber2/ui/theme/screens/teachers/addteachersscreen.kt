...
import com.example.cyber2.navigation.ROUTE_VIEW_TEACHERS


@Composable
fun Addteachersscreen(navController: NavController) {
    ...
    Column(
        ...
        OutlinedTextField(
            ...
            label = { Text(text = "Enter teachers name") },
            placeholder = { Text(text = "Please enter teachers name") },
            modifier = Modifier.fillMaxWidth()
        )
        OutlinedTextField(
            value = gender,
            onValueChange = { newGender -> gender = newGender },
            label = { Text(text = "Enter teachers gender") },
            placeholder = { Text(text = "Please enter teachers gender") },
            modifier = Modifier.fillMaxWidth()
        )
        OutlinedTextField(
            value = nationality,
            onValueChange = { newNationality -> nationality = newNationality },
            label = { Text(text = "Enter teachers nationality") },
            placeholder = { Text(text = "Please enter teachers nationality") },
            modifier = Modifier.fillMaxWidth()
        )
        OutlinedTextField(
            value = course,
            onValueChange = { newCourse -> course = newCourse },
            label = { Text(text = "Enter teachers course") },
            placeholder = { Text(text = "Please enter teachers course") },
            modifier = Modifier.fillMaxWidth()
        )
        OutlinedTextField(
            value = summary,
            onValueChange = { newSummary -> summary = newSummary },
            label = { Text(text = "Enter teachers summary") },
            placeholder = { Text(text = "Please enter teachers summary") },
        ...
        Row(modifier = Modifier.fillMaxWidth()) {
            Button(
                onClick = {
                    imageUri.value?.let {
                        teachersViewModel.uploadTeacherWithImage(
                            it,
                            context,
                            name,
                            gender,
            ...
            )
            {
                Text(
                    text = "GO BACK ",
                    modifier = Modifier.clickable { navController.navigate(ROUTE_VIEW_TEACHERS) })
            }
...
fun AddteachersScreenPreview(){
    Addteachersscreen(rememberNavController())
}