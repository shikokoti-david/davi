...
@Composable
fun UpdateteachersScreen(navController: NavController,teachersId: String){
    ...
    val currentDataRef  = FirebaseDatabase.getInstance()
        .getReference().child("Teachers/$teachersId")
    ...
    Column (modifier = Modifier.padding(10.dp)
        ...
        Box(modifier = Modifier.fillMaxWidth()
            .background(Color.Red).padding(16.dp)){ Text(text = "UPDATE teacher",
        ...
        Row(
            ...
            Button(onClick = {
                ...
                teachersRepository.updateTeacher(
                    context = context,
