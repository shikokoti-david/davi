...
import com.example.cyber2.navigation.ROUTE_UPDATE_STUDENT
...
fun StudentItem(name:String,gender:String,course:String,
                summary: String,nationality : String,studentId:String,imageUrl: String,navController: NavHostController,
